...
def createIndex():
    scaffolding='<!DOCTYPE html><html><head><meta charset="UTF-8"><link rel="stylesheet" type="text/css" href="mystyle.css"><meta http-equiv="refresh" content="35"><title>Projekt</title></head><body></body></html>'
